...
@Component({
  selector: 'app-agent-c',
  templateUrl: './agent-c.component.html',
  styleUrls: ['./agent-c.component.css']
})
export class AgentCComponent {
/* the input reference */
...
exeFun1() {
  ...
  this.http.post<String>('/AgentC',strlist).subscribe(data=>{
